...
const ServiceCard: FC<{ service: Service }> = ({ service }) => {
  ...
  return (
    <article className="card-premium flex flex-col gap-4 overflow-hidden">
      ...
      <div className="grid gap-3 md:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-white/5 via-white/0 to-white/10 ring-1 ring-white/10">
          {service.image ? (
            <div
            ...
            <div className="flex h-full min-h-[160px] flex-col items-center justify-center gap-2 text-white/70">
              <ImageOff className="h-10 w-10" />
              <p className="text-sm">Sin imagen cargada aún</p>
            </div>
          )}
        </div>
      </div>
